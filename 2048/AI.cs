...
namespace _2048
{
    public class AI
    {
        ...
        //public const double MonoWeight   = 0.0,
        //public const double IslandWeight = 0.0;
        ...
        public List<Directions> GetBestMoves2(Grid root)
        {
            ...
            return bests; // last entry is the best
        }
            ...
            if (player)
            {
                ...
                foreach (Transition transition in transitions)
                {
                    ...
                    else
                    {
                        ...
                        //if (result.Item1 > 9900)
                        //    // win
                        //    result.Item1-=0.0; // to slightly penalize higher depth from win
        ...
        {
            return 0;
            // scores for all four directions (up, right, down, left)
